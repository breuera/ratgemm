...
int main() {
  ...
  std::cout << "input: " << input[8] << std::endl;
  ...
  std::cout << "first_half_bf16: " << *first_half_bf16[8] << std::endl; 
  std::cout << "first_half_fp32: " << first_half_fp32[8] << std::endl; 
  ...
  std::cout << "second_half_input: " << second_half_input[8] << std::endl;
  ...
  std::cout << "second_half_bf16: " << *second_half_bf16[8] << std::endl;
  std::cout << "second_half_fp32: " << second_half_fp32[8] << std::endl; 
  ...
  std::cout << "output: " << output[8] << std::endl; // 1 10000001 00100000010100111000111
